...
import cn.com.grentech.www.androidtest.common.websocket.WebSocketTask;
...
public class WebSocketActivity extends AbstractBasicActivity {
    ...
    private void onOpen() {
        try {
            ...
            c = new WebSocketTask(new URI("ws://192.168.5.169:60000/grentechTaxiWx/webSocketServer"), new Draft_17());
            c.connectBlocking();
        } catch (Exception e) {
            e.printStackTrace();
        }
